...
## Маршрутные квитанции и архив
- На вкладке «Маршрутные квитанции» доступен поиск по номеру карты, названию, заказу и фильтр по статусам («Не запущена», «Выполняется», «Пауза», «Смешанно», «Выполнено»).
...
- Кнопка **Log** рядом со скрепкой (во вкладках «Маршрутные квитанции» и «Архив») открывает окно «История изменений маршрутной карты».
